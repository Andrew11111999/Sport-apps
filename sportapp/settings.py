...
SECRET_KEY = 'django-insecure-uo3sbw@1g!++fi%a*)$_vrbh^0%k0)01jtz=z-x&2+!m!+*cc#'
...
PWA_APP_NAME = 'SportApp - Тренировки'
PWA_APP_DESCRIPTION = "Приложение для тренировок дома и в зале"
